...
inputFiles<-"BrownianMotionSimResults_fixedS_lowR_DontCorrectBodySize_RANDOMIZEDHABITATS.txt"            
...
lapply(1:length(rez),FUN=function(x){
  ...
  rez[[x]]$isCrossvalidated<<-length(grep("CROSSVALIDATED",paste0(str_split(string=inputFiles[x],pattern="_")[[1]])))>0
})
